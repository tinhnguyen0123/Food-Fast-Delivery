    ...
    try {
      ...
      if (response.ok) {
        ...
        if (user.role === 'admin') {
          ...
          toast.success(`Chào mừng Quản trị viên ${user.name}!`);
          navigate('/admin/orders', { replace: true }); // Điều hướng đến trang admin
        } else {
          // Nếu đăng nhập thành công nhưng vai trò không phải 'admin'
